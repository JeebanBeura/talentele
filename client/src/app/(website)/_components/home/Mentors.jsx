...
export default function Mentors() {
  ...
  return (
    <Section className="relative bg-[#FAFAFA] pt-10 pb-20 overflow-hidden" useContainer={false}>
      ...
      <motion.div
        ...
        className="absolute top-[20%] right-[30%] w-[40%] h-[40%] rounded-full bg-red-200/40 blur-[150px] pointer-events-none mix-blend-multiply"
      />
      ...
      <Container className="relative z-10">
        ...
        <div className="flex flex-col items-center w-full max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <Text variant="bodyLarge" color="muted" className="max-w-2xl mx-auto text-center mb-4">
        ...
        <div className="w-full overflow-hidden flex">
          <div className="flex animate-marquee-left pause-on-hover items-center">
            {[...MENTORS, ...MENTORS].map((mentor, i) => (
              ...
              >
                <div className="w-48 h-48 md:w-64 md:h-64 rounded-[32px] md:rounded-[32px] overflow-hidden border border-[#EAEAEA] shadow-sm bg-white relative transition-all duration-400 group-hover:shadow-[0_15px_35px_-10px_rgba(230,0,45,0.25)] group-hover:border-[#E6002D]/40 group-hover:scale-[1.05] group-hover:-translate-y-2">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-400 flex items-center gap-2 bg-white/95 backdrop-blur-md text-[#111111] px-5 py-2.5 rounded-full text-sm font-bold shadow-xl">
                      View Profile
                ...
                <div className="text-center">
                  <Heading level="h5" className="text-[#111111] text-lg group-hover:text-[#E6002D] transition-colors duration-300">
                    {mentor.name}
                  </Heading>
                  <Text variant="small" className="text-[#737373] font-medium opacity-80 group-hover:opacity-100 transition-opacity text-sm">
                    {mentor.company}
                  </Text>
                </div>
              </div>
        ...
        {selectedMentor && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-10">
            ...
            <motion.div
              ...
              className="relative w-full max-w-5xl bg-white rounded-[32px] md:rounded-[40px] shadow-2xl border border-[#EAEAEA] overflow-hidden flex flex-col md:flex-row h-auto max-h-[95vh] z-10"
            >
              {/* Close Button */}
              <button
                onClick={() => setSelectedMentor(null)}
                className="absolute top-4 right-4 md:top-6 md:right-6 w-10 h-10 bg-[#FAFAFA] hover:bg-red-50 text-[#111111] hover:text-[#E6002D] rounded-full flex items-center justify-center transition-colors z-20"
              ...
              <div className="w-full md:w-[40%] bg-[#FAFAFA] border-r border-[#EAEAEA] p-8 md:p-10 flex flex-col items-center text-center overflow-y-auto hide-scrollbar">
                <div className="w-40 h-40 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-white shadow-lg mb-6 relative">
                  <img src={selectedMentor.image} alt={selectedMentor.name} className="w-full h-full object-cover" />
                </div>

                <Heading level="h3" className="text-[#111111] mb-2">{selectedMentor.name}</Heading>
                <div className="text-lg font-medium text-[#737373] mb-2">
                  {selectedMentor.role}
                </div>
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-[#EAEAEA] rounded-full text-sm font-bold text-[#111111] shadow-sm mb-8">
                  <div className="w-5 h-5 rounded-full bg-[#FAFAFA] flex items-center justify-center text-[#E6002D] text-[10px]">
                ...
                <div className="grid grid-cols-2 gap-4 w-full mb-8">
                  <div className="flex flex-col items-center p-4 bg-white rounded-2xl border border-[#EAEAEA]">
                    <span className="text-2xl font-black text-[#111111] mb-1">{selectedMentor.experience.split('+')[0]}+</span>
                    <span className="text-[10px] font-bold tracking-wider uppercase text-[#737373]">Years Exp</span>
                  </div>
                  <div className="flex flex-col items-center p-4 bg-white rounded-2xl border border-[#EAEAEA]">
                    <span className="text-2xl font-black text-[#111111] mb-1 flex items-center gap-1">
                      <Star className="w-5 h-5 text-[#F59E0B] fill-[#F59E0B]" />
                      {selectedMentor.rating.split('/')[0]}
                    </span>
                    <span className="text-[10px] font-bold tracking-wider uppercase text-[#737373]">Rating</span>
                  </div>
                </div>
                ...
                <Button variant="outline" className="w-full rounded-xl py-4 h-14 font-semibold border-[#EAEAEA] text-[#0A66C2] hover:bg-[#0A66C2]/5 hover:border-[#0A66C2]/30 transition-all">
              ...
              <div className="w-full md:w-[60%] p-8 md:p-12 overflow-y-auto">
                ...
                <div className="mb-10">
                  ...
                  <Text variant="bodyLarge" color="muted" className="leading-relaxed font-medium">
                ...
                <div className="mb-10">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedMentor.skills.map(skill => (
                      <span key={skill} className="px-4 py-2 bg-[#FAFAFA] border border-[#EAEAEA] rounded-xl text-sm font-semibold text-[#111111]">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                <div className="mb-10">
                  ...
                  <div className="flex flex-col gap-3">
                    {selectedMentor.achievements.map((achievement, idx) => (
                      <div key={idx} className="flex items-center gap-3 p-4 rounded-xl border border-[#EAEAEA] bg-white">
                        <div className="w-8 h-8 rounded-full bg-green-50 flex items-center justify-center text-green-600 shrink-0">
                          <Award className="w-4 h-4" />
                        </div>
                        <span className="font-semibold text-[#525252]">{achievement}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-5 rounded-2xl border border-[#EAEAEA] bg-[#FAFAFA]">
                      <Users className="w-6 h-6 text-[#737373] mb-3" />
                      <div className="text-2xl font-black text-[#111111] mb-1">{selectedMentor.studentsMentored}</div>
                      <div className="text-[11px] font-bold text-[#737373] uppercase tracking-wider">Students Mentored</div>
                    </div>
                    <div className="p-5 rounded-2xl border border-[#EAEAEA] bg-[#FAFAFA]">
                      <BookOpen className="w-6 h-6 text-[#737373] mb-3" />
                      <div className="text-2xl font-black text-[#111111] mb-1">{selectedMentor.courses.length}</div>
                      <div className="text-[11px] font-bold text-[#737373] uppercase tracking-wider">Active Courses</div>
                    </div>
                  </div>
                </div>
