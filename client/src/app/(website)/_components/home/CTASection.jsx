  ...
  return (
    <Section className="relative bg-white dark:bg-[#0F172A] pt-10 overflow-hidden" useContainer={false}>
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-[#E6002D]/10 dark:from-[#E6002D]/20 to-pink-300/10 dark:to-pink-900/10 rounded-full blur-[100px] pointer-events-none mix-blend-multiply dark:mix-blend-screen"
      />
      ...
      <Container className="relative z-10 flex flex-col items-center text-center">
        ...
        >
          <motion.div variants={itemVariants} className="mb-6">
            <div className="inline-flex items-center rounded-full border border-[#E6002D]/20 bg-[#E6002D]/5 dark:bg-[#E6002D]/10 px-4 py-1.5 shadow-sm">
          ...
          <motion.div variants={itemVariants}>
            <Text variant="bodyLarge" color="muted" className="text-[#525252] dark:text-[#A3A3A3] text-center">
          ...
          {BENEFITS.map((benefit, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col items-center p-8 bg-white dark:bg-[#1E293B] rounded-[24px] border border-[#EAEAEA] dark:border-[#334155] shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-[#E6002D]/30 dark:hover:border-[#E6002D]/30"
              >
                {/* Hover Accent Line */}
                ...
                <div className="w-16 h-16 rounded-full bg-[#FAFAFA] dark:bg-[#0F172A] flex items-center justify-center text-[#525252] dark:text-[#94A3B8] mb-6 group-hover:bg-[#E6002D]/10 group-hover:dark:bg-[#E6002D]/10 group-hover:text-[#E6002D] transition-colors duration-300">
                  <Icon className="w-8 h-8" />
                </div>

                <Heading level="h6" className="text-[#111111] dark:text-white mb-3 group-hover:text-[#E6002D] group-hover:dark:text-[#E6002D] transition-colors">
                  {benefit.title}
                </Heading>

                <Text variant="small" className="text-[#737373] dark:text-[#94A3B8]">
                  {benefit.description}
                </Text>
              </motion.div>
            );
        ...
        >
          ...
          <Button variant="outline" size="lg" className="rounded-full bg-white dark:bg-[#1E293B] backdrop-blur-sm border-[#EAEAEA] dark:border-[#334155] hover:bg-[#FAFAFA] dark:hover:bg-[#0F172A] text-[#111111] dark:text-white h-14 px-8 text-base font-semibold shadow-sm w-full sm:w-auto group">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 pt-8 border-t border-[#EAEAEA]/80 dark:border-[#334155]/80 w-full max-w-4xl"
        >
          {TRUST_INDICATORS.map((indicator, idx) => (
            <div key={idx} className="flex items-center gap-2">
              <CheckCircle2 className="w-5 h-5 text-[#16A34A]" />
              <span className="text-sm font-semibold text-[#525252] dark:text-[#E2E8F0]">{indicator}</span>
            </div>
          ))}
        </motion.div>
      </Container>
